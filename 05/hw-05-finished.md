# Задание 1
## Папка my_code (предыдущее дз):
1. Ненадежные зависимости внешних модулей (Использовал ветку main)
2. Отсутствие ограничения версии провайдера (не указывал версии провайдера yandex)
3. Существуют неиспользуемые переменные
Скриншоты для информативности:
<img width="1348" height="1090" alt="изображение" src="https://github.com/user-attachments/assets/92a4d6a8-3cec-4f80-a3bb-38a21c36308b" />

<img width="1454" height="1048" alt="изображение" src="https://github.com/user-attachments/assets/bce6c147-f02f-4df7-a490-3c72b7e022bc" />

## Папка demo:
tflint не выдал ошибок. Checkov выдал ошибки схожие с моим дз. 
